const EnergyProductionCard = (props) => {
  ...
  return (
    <div 
      className={
        props.hasAnomaly
          ? "border border-red-500 rounded-lg h-44"
          : "border border-gray-300 rounded-lg h-44"
      }
    >
      ...
      <div className="p-6 pt-2 flex flex-col items-center">
        <span
          className={
            props.hasAnomaly
              ? "block mb-1 text-3xl font-bold text-red-600"
              : "block mb-1 text-3xl font-bold text-blue-600"
          }
        >
          {props.production}
        </span>
