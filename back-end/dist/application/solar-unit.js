...
exports.deleteSolarUnit = exports.updateSolarUnit = exports.getSolarUnitById = exports.createSolarUnit = exports.getAllSolarUnits = void 0;
var SolarUnit_1 = require("../infrastructure/entities/SolarUnit");
var getAllSolarUnits = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
...
var createSolarUnit = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, serialNumber, installationDate, capacity, status, newSolarUnit, createdSolarUnit, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.body, serialNumber = _a.serialNumber, installationDate = _a.installationDate, capacity = _a.capacity, status = _a.status;
                newSolarUnit = {
...
var getSolarUnitById = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
...
var updateSolarUnit = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, _a, serialNumber, installationDate, capacity, status, solarUnit, updatedSolarUnit;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                id = req.params.id;
...
var deleteSolarUnit = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, solarUnit, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
