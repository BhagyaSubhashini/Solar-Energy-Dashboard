...
function seed() {
    return __awaiter(this, void 0, void 0, function () {
        var solarUnit, records, baseDate, i, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    _a.sent();
                    // Clear existing data
                    return [4 /*yield*/, EnergyGenerationRecord_1.EnergyGenerationRecord.deleteMany({})];
                case 2:
                    // Clear existing data
                    _a.sent();
                ...
                case 4:
                    solarUnit = _a.sent();
                    records = [];
                    baseDate = new Date("2025-09-21T00:00:00Z");
                    for (i = 0; i < 10; i++) {
                        records.push({
                    ...
                    return [4 /*yield*/, EnergyGenerationRecord_1.EnergyGenerationRecord.insertMany(records)];
                case 5:
                    _a.sent();
